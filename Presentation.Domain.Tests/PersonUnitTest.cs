...
namespace Presentation.Domain.Tests
{
    public class PersonUnitTest
    {
        ...
        {
            Action action = () => new Person(fullName: "Paolo Fullone", email: "paolo.fullone@xpi.com.br", city: "Coronel Fabriciano", state: "MG", linkedinUrl: "https://www.linkedin.com/in/paolofullone/", birhtDate: new DateTime(1978, 08, 10));
        ...
        {
            Action action = () => new Person(fullName: "Paolo Fullone", email: "paolo.fullone@xpi.com.br", city: "Coronel Fabriciano", state: "Minas Gerais", linkedinUrl: "https://www.linkedin.com/in/paolofullone/", birhtDate: new DateTime(1978, 08, 10));
